...
// Example dynamic data for "Cars for Sale"
const carsForSaleData = [
    { src: "../images/car-1.jpg", model: "Mazda demio", price: "30,000", description: "Description for Car Model 1", colors: "Red, Blue, Black", seats: "4", images: ['front-view-1.jpg', 'rear-view-1.jpg', 'inner-view-1.jpg']},
    ...
    // Add more cars as per your inventory
];
...
function openModal(index) {
    ...
    document.getElementById('carColor').textContent = `Color: ${car.colors}`;
